...
class SEDReportMigrate extends Command
{
	protected $signature = 'sed-report:migrate
	...
	protected $description = 'Миграции модуля отчета СЭД';
	...
	protected function getTableName(): string
	{
		if ($this->hasArgument('Module') && !empty($this->argument('Module'))) {
			...
			$table_name = strtolower('l_sed_reports_migration');
		}
	...
	{
		$path = '/Modules/SED/Report/Migrations';
		return $path;
	}
