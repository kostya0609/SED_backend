...
use SED\DocumentRoutes\Features\DocumentTemplates\Dto\EditDocTmpDto;

class EditDocTmpRequest extends BaseRequest
{
	protected function getDtoClass(): ?string
	{
		return EditDocTmpDto::class;
	}

	public function createDto(): EditDocTmpDto
	{
	...
	public function messages(): array
	{
		return [
			...
			'parents.array' => 'Родительские шаблоны документов должны быть массивом!',
		];
	}
}
