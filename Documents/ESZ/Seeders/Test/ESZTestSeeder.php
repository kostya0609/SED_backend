<?php
namespace SED\Documents\ESZ\Seeders\Test;
...
class ESZTestSeeder implements SeederInterface
{
	...
	private function generateDocument()
	{
		...
		$dto->receivers = $this->getUsers()->random(random_int(1, 10))->values()->toArray();
		$dto->observers = $this->getUsers()->random(random_int(0, 5))->values()->toArray();
