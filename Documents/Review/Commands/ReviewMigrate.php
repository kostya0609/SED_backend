...
class ReviewMigrate extends Command
{
	protected $signature = 'sed-review:migrate
                            {--reset : Переустановить таблицы}
                            {--remove : Удалить таблицы включая память миграций}
                            {--back= : Откатить миграцию на n шагов}';

	protected $description = 'Миграции модуля ознакомление СЭД';
	...
	{
		return 'l_review_migration';
	}

	protected function getMigrationsPath(): string
	{
		return '/Modules/SED/Documents/Review/Migrations';
	}
