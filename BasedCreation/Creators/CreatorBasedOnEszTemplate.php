<?php
namespace SED\BasedCreation\Creators;
...
use SED\BasedCreation\BasedCreationInterface;
...
class CreatorBasedOnEszTemplate implements BasedCreationInterface
{
	...
	public function create(?Document $base_document = null, DocumentTemplate $template, ?int $initiator_id = null): Document
	{
		...
		$dto->parent_document_id = $base_document->id ?: null;
